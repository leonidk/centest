...
model = Sequential()
model.add(Convolution1D(16,9,border_mode='same',input_dim=1,input_length=70))
model.add(Activation('relu'))
model.add(Convolution1D(32,9,border_mode='same',subsample_length=2))
model.add(Activation('relu'))
model.add(Convolution1D(64,9,border_mode='same',subsample_length=5))
model.add(Activation('relu'))
